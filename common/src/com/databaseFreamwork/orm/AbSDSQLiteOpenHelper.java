 ...
 */
package com.databaseFreamwork.orm;
...
/**
 * 
 * Copyright (c) 2012 All rights reserved 名称：SDSQLiteOpenHelper.java
 * 描述：SD卡中保存数据库
 * 
 * @author zhaoqp
...
public abstract class AbSDSQLiteOpenHelper extends SQLiteOpenHelper {
	 ...
	 *            数据库的新版本号
	 */
	public AbSDSQLiteOpenHelper(Context context, String path, String name, CursorFactory factory, int version) {
