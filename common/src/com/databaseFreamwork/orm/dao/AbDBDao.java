...
public interface AbDBDao<T> {
	...
	public abstract long insertList(List<T> entityList, boolean flag,boolean isReplace);
	...
	public abstract long update(String whereClause, String[] whereArgs);
	 ...
	 * @return 一条数据映射实体
	 */
	public abstract T queryOne(String id);
