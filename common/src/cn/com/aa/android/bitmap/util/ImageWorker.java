...
import cn.com.aa.android.bitmap.util.ImageFetcher.LoadImageFailureListener;
...
public abstract class ImageWorker {
	...
	protected static LoadImageFailureListener loadImageFailureListener;
	 ...
	 */
	public void loadImage(Object data, ImageView imageView, boolean isSaveFlow, LoadImageFailureListener loadImageFailureListener) {
		if (data == null) {
			return;
		}
	...
	public void loadImage(Object data, ImageView imageView, boolean isSaveFlow) {
		loadImage(data, imageView, isSaveFlow, null);
	}

	public void loadImage(Object data, ImageView imageView) {
		loadImage(data, imageView, false, null);
	}
	...
	private class BitmapWorkerTask extends AsyncTask<Object, Void, BitmapDrawable> {
		...
		private boolean isSaveFlow = false;// 是否省流量

		public BitmapWorkerTask(ImageView imageView, boolean isSaveFlow) {
		...
		protected BitmapDrawable doInBackground(Object... params) {
			...
			if (mImageCache != null && !isCancelled() && getAttachedImageView() != null && !mExitTasksEarly) {
				...
				// Log.v("ly", bitmap+" << bitmap --- dataString :"+dataString);
				// Log.d("chexiang.com", "使用本地缓存");
			}
			...
			if (!isSaveFlow && bitmap == null && !isCancelled() && getAttachedImageView() != null && !mExitTasksEarly) {
