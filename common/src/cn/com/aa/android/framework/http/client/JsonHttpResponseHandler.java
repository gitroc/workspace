...
public class JsonHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    private void onFailure(Throwable e, JSONObject errorResponse) {
        Log.e("JsonHttpResponseHandler", e.getMessage());
    }
    private void onFailure(Throwable e, JSONArray errorResponse) {
        Log.e("JsonHttpResponseHandler", e.getMessage());
    }
    ...
    protected void sendSuccessMessage(Context context,int statusCode, String responseBody) {
        ...
        try {
            ...
            sendFailureMessage(context,e, responseBody);
        }
    }
